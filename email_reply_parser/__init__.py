...
class EmailReplyParser(object):
    ...
    @staticmethod
    def cut_off_at_signature(body: str, include: bool = True, word_limit: Optional[int] = 100):
        """
...
class EmailMessage(object):
    ...
    @staticmethod
    def clean_email_content(body, include, word_limit):
        """
